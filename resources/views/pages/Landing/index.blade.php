...
@section('content')
    ...
    <div class="content">
        ...
        <!-- call to action -->
        <div class="py-10 lg:py-24 flex lg:flex-row flex-col items-center cta-bg primary-bg">
            <!-- Left Column -->
            <div class="w-full lg:w-9/12 text-center justify-center flex lg:mb-0 mb-12">
                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                    <img id="hero" src="{{ asset('/assets/images/placeholder.png') }}" alt="" class="p-5" />
                </a>
            </div>
            <!-- Right Column -->
            <div class="lg:w-4/12 w-full flex flex-col lg:items-start items-center lg:text-left text-center">
                <h2 class="md:text-4xl text-3xl font-semibold mb-10 lg:leading-normal text-medium-black">
                    Find The Best <br>
                    <span style="color: #3E66FB">Freelancers</span> Here
                </h2>
                <p class="text-lg leading-relaxed text-serv-text font-light mb-10 lg:mb-18">
                    Sobatlancer has by far the largest pool of quality freelancers<br class="lg:block hidden">
                    globally over 500 Sobatlance to choose from. In addition,<br class="lg:block hidden">
                    Sobatlancer provides a search feature for professionals<br class="lg:block hidden">
                    you can trust by browsing their samples from past jobs <br class="lg:block hidden">
                    and reading reviews about their profiles.
                </p>
                <a
                    href="explore.php"
